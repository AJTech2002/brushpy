...
1. `Primitive` as a `struct` which has inheritance - it just contains data about what the primitive is and how to draw it, the Layer uses that to render it onto the screen. 
	1. 